      ...
      >
        <View style={styles.headerModal}>
          <View style={styles.title}>
            <Text style={styles.titleText}>Regain access</Text>
          </View>
          <TouchableOpacity
        ...
        >
          <View style={styles.modalContainer}>
            ...
            <View style={{ height: 145, marginHorizontal: 32, marginTop: 23, backgroundColor: '#FFFFFF' }}>
              <View style={{}}>
                <TextInput
                  placeholder="Email"
              ...
              <TouchableOpacity onPress={() => navigation.navigate('Login')} style={styles.bigButton}>
                <Text style={styles.bigBtnText}>Password reset</Text>
