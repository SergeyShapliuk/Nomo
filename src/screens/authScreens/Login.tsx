      ...
      >
        ...
        >
          <View style={styles.modalContainer}>
            ...
            <View style={{ height: 217, marginHorizontal: 32, marginTop: 23, backgroundColor: '#FFFFFF' }}>
              <View style={{}}>
                <TextInput
                  placeholder="Email"
              ...
              <TouchableOpacity onPress={() => navigation.navigate('Recovery')} style={styles.bigButton}>
